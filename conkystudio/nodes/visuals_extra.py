...
# Shared full gradient set (incl. extend) + blend operator — same source of
# truth as visuals.py / visuals_more.py so duplicate registration stays a
# no-op and every fill-capable node exposes the same Style controls.
