...
What this does:
  1. Registers NodeSpecs (logic_extra, visuals_extra, visuals_more, sources_extra, visuals_niche)
...
try:
    import conkystudio.nodes.visuals_niche  # noqa: F401
except ImportError as e:
    print(f"[conky-studio] visuals_niche: {e}")
...
try:
    ...
    from conkystudio.codegen.visual_generators_niche import register as reg_visual_niche
    reg_logic(lua_gen.logic_generator)
    reg_visual(lua_gen.visual_generator)
    reg_visual_more(lua_gen.visual_generator)
    reg_visual_niche(lua_gen.visual_generator)
