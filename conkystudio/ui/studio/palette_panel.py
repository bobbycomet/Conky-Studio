...
_CATEGORY_LABELS = [("source", "Data Sources"), ("logic", "Logic"), ("visual", "Visuals")]
...
class PalettePanel(QWidget):
    ...
    def _refresh(self, *_args):
        ...
        for category, cat_label in _CATEGORY_LABELS:
            ...
            for spec in specs:
                by_sub.setdefault(spec.subcategory, []).append(spec)

            for subcat in registry.subcategories_in(category):
                ...
                sub_item.setExpanded(bool(query) or category != "visual")
    ...
    def _resize_tree_to_contents(tree: QTreeWidget):
        ...
        tree.setFixedHeight(rows * row_h + tree.frameWidth() * 2 + 4)
