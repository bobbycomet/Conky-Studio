...
class PluginsDialog(QDialog):
    # Categories plugins may use (schema allows logic + visual; source is
    # listed for completeness if a pack ever ships one).
    _CATEGORY_FILTERS = ("All", "Logic", "Visual", "Source")
    ...
    def __init__(self, parent=None):
        ...
        self.installed_category.setToolTip(
            "Show only installed plugins in this category (Logic / Visual / Source)"
        )
    ...
    def _filter_category_value(self, combo: QComboBox):
        """None = All; otherwise lowercase category name (logic/visual/source)."""
