...
[Video Showcase](https://youtu.be/RbUr9pFosDc) · [Discord](https://discord.gg/kJZCZWg5nw) · [YouTube](https://www.youtube.com/@BobbyComet) · [WIKI](https://github.com/bobbycomet/Conky-Studio/wiki) · [Best paired with this updater](https://github.com/bobbycomet/GriffinUpdater) · [Latest Build](https://github.com/bobbycomet/Conky-Studio/releases/download/v1.0.2/Conky-Studio-1.0.2_x86_64.AppImage)
...
**Community-driven (maybe):** animation keyframes, built-in profiler, multi-monitor support; depends on feedback.
